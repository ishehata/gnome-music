...
const AlbumWidget = new Lang.Class({
    ...
    update: function (artist, album, item) {
        ...
        if (cachedPlaylist){
            ...
            this.updateModel(cachedPlaylist, new Gtk.Iter);
        } else {
...
const ArtistAlbums = new Lang.Class({
    ...
    _init: function (artist, albums) {
        ...
        if (cachedPlaylist){
            ...
            for (var i=0; i < albums.length; i++) {
                let widget = new ArtistAlbumWidget(artist, albums[i], this.model)
    ...
    updateModel: function(currentIter){
...
const ArtistAlbumWidget = new Lang.Class({
    ...
    _init: function (artist, album, model) {
        this.parent();
        this.album = album;
        this.artist = artist;
        this.model = model;
